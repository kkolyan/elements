 ...
 * @author nplekhanov
 */
public class CrimsonLandStyleTankController extends CompoundUniObject implements CrimsonLandStyleControllable, TickListener {
    ...
    @Override
    public void move(double timeMovement, double direction) {
        object.setDirection(direction);
        object.move(timeMovement);
    }
